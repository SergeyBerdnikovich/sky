...
class StaticPagesControllerTest < ActionController::TestCase
  ...
  test "should create static_page" do
    assert_difference('StaticPage.count') do
      post :create, static_page: { content: @static_page.content, name: @static_page.name, title: @static_page.title }
    end
  ...
  test "should update static_page" do
    put :update, id: @static_page, static_page: { content: @static_page.content, name: @static_page.name, title: @static_page.title }
    assert_redirected_to static_page_path(assigns(:static_page))
  end
