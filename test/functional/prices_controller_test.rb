...
class PricesControllerTest < ActionController::TestCase
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post :create, price: { flate: @price.flate, per_sq: @price.per_sq, size_from: @price.size_from, size_to: @price.size_to }
    end
  ...
  test "should update price" do
    put :update, id: @price, price: { flate: @price.flate, per_sq: @price.per_sq, size_from: @price.size_from, size_to: @price.size_to }
    assert_redirected_to price_path(assigns(:price))
  end
